...
useSeoMeta({
  ...
  ogImage: '/hero-contact-connection.png',
  ogImageAlt: 'Contact Zar Media Group — free accounting firm website audit and client portal consultation in Cape Town, South Africa',
  schemas: [
    SCHEMAS.breadcrumb([
      { name: 'Home', url: '/' },
